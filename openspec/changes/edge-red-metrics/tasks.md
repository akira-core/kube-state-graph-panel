...
- [ ] 7.6 Run `/opsx:verify` and reconcile any spec/implementation divergence before archiving. (There is no `openspec verify` CLI subcommand — verification is the skill. `openspec validate edge-red-metrics --strict` passes.)
